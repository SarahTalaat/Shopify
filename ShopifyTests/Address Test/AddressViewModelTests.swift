...
////        // Given
////        let mockResponse = AddressResponse(customer_address: Address(id: 1, first_name: "Marim", address1: "123 Street", city: "Alex", country: "Egypt", zip: "12345", `default`: false))
////        networkService.result = .success(mockResponse)
////        
////        // When
////        let expectation = self.expectation(description: "Success")
////        viewModel.onAddressesUpdated = {
////            print("onAddressesUpdated called")
////            expectation.fulfill()
////        }
////        print("Calling deleteAddress(at:)")
...
////        // Given
////        let mockResponse = AddressResponse(customer_address: Address(id: 1, first_name: "Marim", address1: "123 Street", city: "Alex", country: "Egypt", zip: "12345", `default`: true))
////        networkService.result = .success(mockResponse)
////        viewModel.addresses = [Address(id: 1, first_name: "Marim", address1: "123 Street", city: "Alex", country: "Egypt", zip: "12345", `default`: false)]
////        
////        // When
